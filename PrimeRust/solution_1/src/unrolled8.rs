...
use crate::{flag_storage::FlagStorage, patterns::{index_pattern, MASK_PATTERNS_U8}, unrolled32::ResetterDenseU32};
...
impl FlagStorageUnrolledBits8 {
    ...
    fn reset_flags_sparse<const EQUIVALENT_SKIP: usize>(&mut self, skip: usize) {
        ...
        let bytes: &mut[u8] = unsafe { transmute(&mut self.words[..]) };
